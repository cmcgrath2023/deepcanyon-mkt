...
export const metadata: Metadata = {
  ...
  openGraph: { title: "What We Offer — Deep Canyon", description: "AI-powered trading across every major asset class.", images: [{ url: "https://deepcanyon.ai/Meta-OG.png", width: 1200, height: 630 }] },
};
import {
  Bitcoin,
  DollarSign,
