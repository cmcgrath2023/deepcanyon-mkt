...
const cards = [
  ...
  },
  {
    ...
    href: "/product/crypto",
    accent: "#D4A843",
    solidColor: "#285A48",  // canyon-green
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="relative">
          {cards.map((c, i) => {
            ...
            // Each card sticks 30px lower than the previous
            const topOffset = 80 + i * 30;
              ...
              <div key={c.label}>
                ...
                >
                  <div className="flex flex-col md:flex-row min-h-[600px]">
                    ...
                    {/* Right half — canyon bg with visual overlay */}
